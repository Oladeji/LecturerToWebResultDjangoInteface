    ...
    for crs in courselist:
            ...
            for i in list(availabuSemesters):
                ...
                if i.myCampId==crs['MYCAMPID'] and i.myProgId==crs['MYPROGID'] and i.myAsetId==crs['MYASETID'] and i.myAsessionId==crs['MYASESSIONID'] and i.mySemesterId==crs['MYSEMESTERID'] and i.myTheprogType==crs['MYTHEPROG'] :
                  ...
                  print("Not Found",i.myCampId,crs['MYCAMPID'] , i.myProgId,crs['MYPROGID'] , i.myAsetId,crs['MYASETID'] , i.myAsessionId,crs['MYASESSIONID'] , i.mySemesterId,crs['MYSEMESTERID'] , i.myTheprogType,crs['MYTHEPROG'] )
    print('seeeeeeeeeeeeeeeeeeeeeeeendfilterUnAvailableSemesters')  
    print(newcourselist)
